...
### Описание документации для разработчика
Здесь представлена документация разработчика, описывающая основные принципы и структуру проекта.

[Ссылка на окументацию](file:///D:/Daria/Project/documentation/html/index.html)
